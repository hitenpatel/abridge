...
export function FloatingTabBar({ state, descriptors, navigation }: BottomTabBarProps) {
	return (
		<View
			className="mx-4 mb-4 h-16 bg-white dark:bg-neutral-surface-dark/90 rounded-full flex-row items-center justify-between px-2 border border-white/20 dark:border-white/5"
			style={{
				shadowColor: "#000",
